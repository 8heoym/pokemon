...
const BadgeCase: React.FC<BadgeCaseProps> = ({ user, isOpen, onClose }) => {
  ...
  const allBadges: Badge[] = [
    ...
    // PRD [F-1.6]: 모든 구구단 테마 지역 배지
    {
      id: 'grassland_master',
      name: '피카츄의 풀숲 정복자',
      description: '2단 구구단 지역을 완전히 정복했습니다',
      imageUrl: '/images/badges/grassland_badge.png',
      category: 'progress',
    ...
    },
    {
      ...
      imageUrl: '/images/badges/pond_badge.png',
      category: 'progress',
    ...
    },
    {
      ...
      imageUrl: '/images/badges/garden_badge.png',
      category: 'progress',
      earnedAt: user.completedTables.includes(4) ? new Date('2025-09-04') : undefined,
    },
    {
      id: 'volcano_master',
      name: '파이리의 화산 정복자',
      description: '5단 구구단 지역을 완전히 정복했습니다',
      imageUrl: '/images/badges/volcano_badge.png',
      category: 'progress',
      earnedAt: user.completedTables.includes(5) ? new Date('2025-09-05') : undefined,
    },
    {
      id: 'forest_master',
      name: '라이츄의 숲 수호자',
      description: '6단 구구단 지역을 완전히 정복했습니다',
      imageUrl: '/images/badges/forest_badge.png',
      category: 'progress',
      earnedAt: user.completedTables.includes(6) ? new Date('2025-09-06') : undefined,
    },
    {
      id: 'desert_master',
      name: '나인테일의 사막 정복자',
      description: '7단 구구단 지역을 완전히 정복했습니다',
      imageUrl: '/images/badges/desert_badge.png',
      category: 'progress',
      earnedAt: user.completedTables.includes(7) ? new Date('2025-09-07') : undefined,
    },
    {
      id: 'cave_master',
      name: '골덕의 동굴 탐험가',
      description: '8단 구구단 지역을 완전히 정복했습니다',
      imageUrl: '/images/badges/cave_badge.png',
      category: 'progress',
      earnedAt: user.completedTables.includes(8) ? new Date('2025-09-08') : undefined,
    },
    {
      id: 'peak_master',
      name: '윈디의 설산 정복자',
      description: '9단 구구단 지역을 완전히 정복했습니다',
      imageUrl: '/images/badges/peak_badge.png',
      category: 'progress',
      earnedAt: user.completedTables.includes(9) ? new Date('2025-09-09') : undefined,
    },
    {
